...
from Node import *
from featuresBase import FeatureMap
...
def processDepSentence(sid, sent, acc):
	...
	trFM, taFM, reFM = acc['transitionFeatureMap'], acc['targetFeatureMap'], acc['readoutFeatureMap']
...
def main():
	...
	acc = {'transitionFeatureMap' : FeatureMap(), 'targetFeatureMap' : FeatureMap(), 'readoutFeatureMap' : FeatureMap()}
