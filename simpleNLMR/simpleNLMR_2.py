...
class SimpleNLMR_2(base.BaseEstimator):
	def __init__(self, state_dim = 100, initial_feature_scaling_factor = 0.1, initial_contraction_coefficient = 0.99, is_esn = False, bttp_truncation = -1, optimizer_opts = {}, tr_l2_reg = 0.0, ta_l2_reg = 0.0, rf_l2_reg = 0.0, rec_l2_reg = 0.0, initial_state_l2_reg = 0.0, dtype = None, random_state = 0, verbose = 0):
